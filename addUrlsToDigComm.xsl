       ...
       <record>
        <mods:location>
            ...
            <mods:url usage='primary display' access='object in context'>
                ...
                <xsl:value-of select="concat('http://bclsco.bc.edu/catalog/oai:dcollections.bc.edu:',/*/pid)"/>
            </mods:url>                    
            ...
            <mods:url access='raw object'>
                <xsl:value-of select="concat('http://dcollections.bc.edu/webclient/DeliveryManager?pid=',/*/pid,'&amp;custom_att_2=simple_viewer&amp;local_base=GEN01-BCD01')"/>
           </mods:url>
        </mods:location>
        <mods:identifier type="hdl">
           <xsl:text>http://hdl.handle.net/2345</xsl:text>
